...
class LibrosDoc(Document):
    ...
    class Book(Line):
        class Field(Enum):
            ...
            DATE_LAUNCH = (1477, 8, t.DATE8, "Fecha de puesta en venta o lanzamiento, en formato AAAAMMDD")
            DATE_AVAILABLE = (1485, 8, t.DATE8, "Fecha de disponibilidad de existencias, en formato AAAAMMDD")

...
class LibrosDoc(Document):
    ...
    class Book(Line):
        class Field(Enum):
            ...
            TB_REGION = (1316, 36, "Libro de texto: Lista de códigos de comunidades autónoma, separados por '/'.")
            SUMMARY = (1352, 255, "Resumen, sinopsis")
            IBIC_VERSION = (1607, 3, "iBIC: Tipo de versión. ej: 1.1")
            IBIC_TOPICS = (1610, 50, "iBIC: Lista de temas (materias) separados por ';'")
            DATE_LAUNCH = (1660, 8, "Fecha de puesta en venta o lanzamiento, en formato AAAAMMDD")
            DATE_AVAILABLE = (1668, 8, "Fecha de disponibilidad de existencias, en formato AAAAMMDD")
            URL = (1676, 199, "Dirección URL. Se recomienda nombrar al menos con el EAN en las primeras posiciones")
            SUMMARY_EXT = (1875, 1125, "Resumen o sinopsis ampliadas")

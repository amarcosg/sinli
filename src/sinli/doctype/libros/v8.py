...
.
            ...
            DATE_LAUNCH = (1660, 8, t.DATE8, "Fecha de puesta en venta o lanzamiento, en formato AAAAMMDD")
            DATE_AVAILABLE = (1668, 8, t.DATE8, "Fecha de disponibilidad de existencias, en formato AAAAMMDD")

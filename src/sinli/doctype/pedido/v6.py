...
class PedidoDoc(Document):
    ...
    class Detail(Line):
        class Field(Enum):
            ...
            ORDER_SOURCE = (118, 1, c.ORDER_SOURCE, "Origen del pedido: N (normal), C (cliente)")
            EXPRESS = (119, 1, t.BOOL, "Envío en menos de 24h con gastos de envío especiales S/N")
            ORDER_CODE = (120, 10, t.STR, "Código de pedido")

    class SimpleDetail(Line):
        class Field(Enum):
            TYPE = (0, 1, t.STR, "Tipo de registro")
            TEXT = (1, 80, t.STR, "Texto libre. En caso de desconocer los identificadores de los libros")
